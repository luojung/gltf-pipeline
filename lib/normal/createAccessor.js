 ...
 * @Description: 
 * @Author: luojun1
 * @Date: 2021-12-24 11:48:50
 * @LastEditTime: 2021-12-29 16:52:20
 */
'use strict';
...
function createAccessor(gltf, dataOrLength, type, componentType, target, id) {
    ...
    if (!defined(id)) {
        ...
        id = gltf.accessors.length
    }
    // var bufferViewId = getUniqueId(gltf, 'bufferView');
    var bufferViewId = gltf.bufferViews.length
    // var bufferId = getUniqueId(gltf, 'buffer');
    var bufferId = gltf.buffers.length
